...
def mogp():
    ...
    pyemu.os_utils.start_workers("template","./pest/pestpp-mou","./pest/henry_gp.pst",num_workers=64,worker_root=".",master_dir="./mogp_"+str(next_inner_index))  
...
def start_prep():
    ...
    curr_obs.to_csv(os.path.join(path_in,"mogp_henry.obs_pop.csv"), index=False)
    ...
    curr_dv.to_csv(os.path.join(path_in,"mogp_henry.dv_pop.csv"), index=False)
